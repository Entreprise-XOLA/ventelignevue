      ...
      <q-list>
        <center>
          <q-item-label header style="background: linear-gradient(green, #fff)">
            <!--
              <img
              src="../assets/geversetrans.png"
              style="height: 110px; max-width: 110px;margin-top:20px auto"
            />
            -->
        ...
        <q-separator inset />
        <q-item to="/chiffreaffaire" exact>
          <q-item-section avatar>
