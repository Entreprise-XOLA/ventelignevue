  ...
  <q-page>
    ...
    <div class="row bg-green text-white" style="margin: 20px;">
      <div style="width: 80%;margin:auto;">
        <div style="margin:10px auto; text-align:center; color: yellow; font-weight: bold; text-transform: uppercase">Crée un compte</div>
        <q-input square outlined v-model="fullname" label="Nom complet" bg-color="white"/><br>
        ...
        <q-input square outlined v-model="confirmpassword" label="Confirmer Mot de passe" bg-color="white" type="password"/><br>
        <br><br>
        <div style="text-align:center; color: yellow"> Vous disposez déjà d'un compte <span @click="nvoConn" style="color:white">Connectez-vous !</span></div>
        <br><br>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    onSubmit () {
      ...
      params.append('idutilisateur', this.fullname)
      params.append('idrole', this.idrole)
      params.append('nom', this.fullname)
      params.append('email', this.email)
      params.append('password', this.password)
      params.append('confirmpwd', this.confirmpassword)
      
      console.log(this.email)
      
       this.$axios.post(`http://localhost/E-Commerce/index.php/Ecommerce/ajout_inscription?`, params)
        .then(response => { 
          // envoie des infos
